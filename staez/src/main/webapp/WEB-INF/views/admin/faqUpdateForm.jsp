...
<body>
    <header>
        ...
        <script src="<c:url value='/resources/js/admin/faqUpdateForm.js'/>"></script>
    </header>
    <main>
        <div id="community-wrapper">
            <form id="community-contents" align="left" method="post" action="update.bo">
                <input type="hidden" name="boardNo">
                <input type="hidden" name="url" value="faqList.ad">
                <h1>FAQ</h1>
                <hr>
                <li>
                    <h3>제목</h3>
