...
<body>
	<header>
        ...
        <script src="<c:url value='/resources/js/admin/inquireMain.js'/>"></script>
	</header>
    <nav>
    ...
    <main>
        <ul id="admin-main-wrapper">
            ...
            <li>
                <button class="btn-staez purple" id="admin-answer-inquire"><h4>답변</h4></button>
                <button class="btn-staez purple" id="admin-delete-inquire"><h4>삭제</h4></button>
            </li>
