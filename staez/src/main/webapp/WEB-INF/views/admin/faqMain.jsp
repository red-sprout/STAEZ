...
<body>
    ...
    <main>
        <ul id="admin-main-wrapper">
            ...
            <li>
                <button class="btn-staez purple" onclick="location.href='faqIncertForm.ad'"><h4>추가</h4></button>
                <button class="btn-staez purple" onclick="location.href='faqUpdateForm.ad'"><h4>수정</h4></button>
