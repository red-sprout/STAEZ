...
public class AdminUserDao {
	...
	public int selectUserCnt(SqlSessionTemplate sqlSession, AdminSearchDto dto) {
		return sqlSession.selectOne("adminMapper.selectUserCnt", dto);
	}

	public ArrayList<User> selectUser(SqlSessionTemplate sqlSession, AdminSearchDto dto, PageInfo pi) {
